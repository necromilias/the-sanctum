import { User, Zap, Clock, MessageSquare, type LucideIcon } from 'lucide-react';
...
type TinaContent = ComponentProps<typeof TinaMarkdown>['content'];

interface AboutSection {
  section_type?: string;
  title?: string;
  content?: string | TinaContent;
...
export default function About() {
  ...
  return (
    <main className="relative max-w-4xl mx-auto px-4 sm:px-6 md:px-8 py-6 md:py-8 animate-fade-in">
    <div className="mb-7">
    ...
    {sections.length === 0 ? (
      ...
      <div className="space-y-6">
        {sections.map((section) => {
          ...
          return (
            <div key={section._key} className="glass-panel p-5 md:p-8">
              ...
              <div className="text-ghost-300 leading-relaxed">
                {!section.content ? null : typeof section.content === 'string' ? (
                  section.content
                    .trim()
                    .split(/\n\s*\n/)
                    .filter(Boolean)
